...
/*Motor 1 configeration*/
#define MOTOR1_BV                  BV(3)
#define MOTOR1_SBIT              P0_3
#define MOTOR1_DDR               P0DIR
#define MOTOR1_POLARITY      ACTIVE_HIGH
#define MOTOR1_PSEL              P0SEL

/*Motor 2 configeration*/
#define MOTOR2_BV                  BV(4)
#define MOTOR2_SBIT              P0_4
#define MOTOR2_DDR               P0DIR
#define MOTOR2_POLARITY      ACTIVE_HIGH
#define MOTOR2_PSEL              P0SEL

/*Motor 3 configeration*/
#define MOTOR3_BV                  BV(5)
#define MOTOR3_SBIT              P0_5
#define MOTOR3_DDR               P0DIR
#define MOTOR3_POLARITY      ACTIVE_HIGH
#define MOTOR3_PSEL              P0SEL

/*Motor 4 configeration*/
#define MOTOR4_BV                  BV(6)
#define MOTOR4_SBIT              P0_6
#define MOTOR4_POLARITY      ACTIVE_HIGH
#define MOTOR4_DDR               P0DIR
#define MOTOR4_PSEL              P0SEL

/*mode sellect pin*/
#define P2_MODE_SBIT           P0_7                      
#define P2_MODE_DDR            P0DIR
#define P2_MODE_PSEL           P0SEL
#define P2_MODE_BV               BV(7)

/*battery voltage ADC PIN*/
#define P2_Battery_ADC_SBIT  P0_2
#define P2_Battery_ADC_BV      BV(2)
#define P2_Battery_ADC_DDR    P0DIR
#define P2_Battery_ADC_PSEL   P0SEL

//motor PWM output need to set T1 output from alternative 1 location
#define T1CFG                          BV(6)


//duty cycle for the motor
#define MOTOR_RUN_STRONG               0x01
#define MOTOR_RUN_MODERATE           0x53
#define MOTOR_RUN_WEEK                   0xA6
#define MOTOR_RUN_OFF                     0xFB
...
#ifndef HAL_MOTOR
#define HAL_MOTOR TRUE
#endif

#ifndef BLINK_MOTORS
#define BLINK_MOTORS TRUE
#endif
...
#define button_battery      FALSE

#if P2_BLE
#define P2_POWER_BV               BV(0)
#define P2_POWER_SBIT            P0_0
#define P2_POWER_DDR             P0DIR
#define P2_POWER_PSEL            P0SEL
#endif
